    ...
    <section class="cq-auth-panel">
        <div class="cq-card">
            ...
            <form role="form" action="/loginStud" method="POST" autocomplete="on">
                <div class="cq-field"><label class="cq-label" for="username">Usuário</label><input type="text" id="username" name="username" class="cq-input" placeholder="Seu usuário" required autofocus autocomplete="username"></div>
