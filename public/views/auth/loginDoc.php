    ...
    <section class="cq-auth-panel">
        <div class="cq-card">
            <div class="cq-role-switch" aria-label="Escolha do acesso">
                <a href="/loginStud">Crismando</a>
                <a class="active" href="/loginDoc">Catequista</a>
            </div>
            ...
            <form role="form" action="/loginDoc" method="POST" autocomplete="on">
                <div class="cq-field">
                    <label class="cq-label" for="inputUser">Usuário</label>
                    <input type="text" id="inputUser" name="inputUser" class="cq-input" placeholder="Seu usuário" required autofocus autocomplete="username">
                </div>
                <div class="cq-field">
                    <label class="cq-label" for="inputPassword">Senha</label>
                    <input type="password" id="inputPassword" name="inputPassword" class="cq-input" placeholder="Sua senha" required autocomplete="current-password">
                </div>
            ...
            <div class="cq-footnote">CrismaQuest · Paróquia Nossa Senhora dos Remédios</div>
        </div>
    </section>
</div>
