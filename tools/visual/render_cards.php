...
$cards=array_filter($catalog,static fn($card)=>in_array($card['slug'],['santa-teresinha-menino-jesus','sao-francisco-assis','santo-inacio-antioquia'],true));
ob_start();
?>
...
<?php foreach ($cards as $card): $card['quantity']=1; $card['fallback_image_path']=''; ?>
